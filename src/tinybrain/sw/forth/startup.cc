...
extern "C" void Reset_Handler() {
  ...
  // Jump to main
  asm volatile("msr msp, %[stack_top]\n"
...
extern "C" __attribute__((noreturn)) inline void DefaultISR() {
...
#define DEFINE_DEFAULT_ISR(name)                                               \
  extern "C" __attribute__((weak, noreturn)) void name() { DefaultISR(); }
...
volatile const std::uintptr_t g_exception_table[] __attribute__((
